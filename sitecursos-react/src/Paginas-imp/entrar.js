                    ...
                    <div className="col-8 col-md-4 col-lg-4 cadastro text-center p-4 my-4 " 
                        ...
                        <form className="row g-3 p-5">
                            <div className="col-md-12">
                                ...
                                <input type="text" placeholder="Login" required value={login} onChange={(e) => setLogin(e.target.value)} onFocus={(e) => (e.target.style.borderColor = '#4297e1')} className="form-control"/>
                            </div>
                            ...
                            <div className="col-12">
                                <button type="submit" id="entrar" className="btn botao-login w-50"> Entrar</button>
                            </div>
                            <Link to="/esqueceu-senha" class="links">Esqueceu a senha?</Link>{' '}
                            <Link to="/cadastrar" class="links">Cadastrar</Link>
                        </form>
                    </div>
                </div>
            </div>
